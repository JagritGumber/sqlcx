...
pub fn zod_type(sql_type: &SqlType, _overrides: &Overrides) -> String {
    ...
    match &sql_type.category {
        ...
        // z.instanceof is available in Zod v3 (removed in v4)
        SqlTypeCategory::Binary => "z.instanceof(Uint8Array)".to_string(),
...
impl SchemaGenerator for ZodV3Generator {
...
mod tests {
    ...
    #[test]
    fn generates_zod_v3_schema() {
        let ir = parse_fixture_ir();
        let gen = ZodV3Generator;
        ...
        insta::assert_snapshot!("zod_v3_schema", file.content);
    }
}
