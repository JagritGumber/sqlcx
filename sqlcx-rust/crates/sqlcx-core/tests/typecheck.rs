...
fn build_fixture_ir() -> SqlcxIR {
    let schema_sql = include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/../../tests/fixtures/schema.sql"));
    let queries_sql = include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/../../tests/fixtures/queries/users.sql"));
...
fn run_tsc(typecheck_base: &str, subdir: &str, files: &[sqlcx_core::generator::GeneratedFile]) -> std::result::Result<bool, String> {
